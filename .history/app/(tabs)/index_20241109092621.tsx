...
import { StyleSheet, View, FlatList, Animated, Dimensions, TouchableOpacity, NativeSyntheticEvent, NativeScrollEvent } from 'react-native';
    ...
    <ParallaxScrollView
      ...
      headerImage={
        <View style={styles.imageContainer}> 
          <Icon name="home-circle-outline" size={100} color="#01F0D0" />
        </View>
      }>
