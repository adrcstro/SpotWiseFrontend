...
const ScanScreen = () => {
  ...
  const loadModel = async () => {
    try {
      ...
      // Directly require the JSON content, not a URI
      const modelJson = require('../../assets/model.json');
      
      // Use Asset.fromModule for binary files to get their URIs
      const modelWeights = [
        Asset.fromModule(require('../../assets/group1-shard1of7.bin')).uri,
        Asset.fromModule(require('../../assets/group1-shard2of7.bin')).uri,
        Asset.fromModule(require('../../assets/group1-shard3of7.bin')).uri,
        Asset.fromModule(require('../../assets/group1-shard4of7.bin')).uri,
        Asset.fromModule(require('../../assets/group1-shard5of7.bin')).uri,
        Asset.fromModule(require('../../assets/group1-shard6of7.bin')).uri,
        Asset.fromModule(require('../../assets/group1-shard7of7.bin')).uri,
      ];
