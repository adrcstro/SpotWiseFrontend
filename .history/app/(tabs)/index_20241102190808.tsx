...
const educationalContent = [
  {
    ...
    description: "Skin cancer is the abnormal growth of skin cells, commonly caused by exposure to the sun. Early detection is key for successful treatment.",
    imageSource: require('@/assets/images/SkinCancer.png'),
  },
  {
    title: "Tips for Healthy Skin",
    description: "Maintain a regular skincare routine, avoid prolonged sun exposure, and use sunscreen daily to protect your skin from harmful UV rays.",
    imageSource: require('@/assets/images/HealthySkin.png'),
  },
  {
    title: "Understanding Moles and Freckles",
    description: "Moles and freckles are common, but any changes in size, shape, or color could indicate a need for medical attention.",
    imageSource: require('@/assets/images/MolesFreckles.png'),
  },
];
...
export default function HomeScreen() {
  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.educationalContentContainer}>
        <ThemedText type="title" style={styles.educationHeader}>Learn About Skin Health</ThemedText>
        {educationalContent.map((item, index) => (
          <EducationalCard key={index} {...item} />
        ))}
      </ThemedView>
    </ParallaxScrollView>
  );
...
const EducationalCard = ({ title, description, imageSource }: StepProps) => (
