...
const ScanScreen = () => {
  ...
  const loadModel = async () => {
    try {
      await tf.ready();
      const modelJson = require('../../assets/Densnet121/Densnet121.json');
      const modelWeights = [
        require('../../assets/Densnet121/group1-shard1of7.bin'),
        require('../../assets/Densnet121/group1-shard2of7.bin'),
        require('../../assets/Densnet121/group1-shard3of7.bin'),
        require('../../assets/Densnet121/group1-shard4of7.bin'),
        require('../../assets/Densnet121/group1-shard5of7.bin'),
        require('../../assets/Densnet121/group1-shard6of7.bin'),
        require('../../assets/Densnet121/group1-shard7of7.bin'),
      ];

      // Use bundleResourceIO to correctly load the model
