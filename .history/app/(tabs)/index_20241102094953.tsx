    ...
    <ParallaxScrollView
      ...
      headerImage={
        <View style={styles.imageContainer}>
          <Image source={require('@/assets/images/WelcomeScreen.png')} style={styles.reactLogo} />
        </View>
      }>
...
const styles = StyleSheet.create({
  ...
  titleText: {
    fontFamily: 'CustomFont-Bold', // Replace with your font's name
    fontSize: 24,
    fontWeight: 'bold',
    color: '#333',
  },
  descriptionText: {
    fontFamily: 'CustomFont-Regular', // Replace with your font's name
    fontSize: 16,
    color: '#555',
  },
  stepContainer: {
