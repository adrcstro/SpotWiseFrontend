...
const ScanScreen = () => {
  ...
  const loadModel = async () => {
    try {
      // Directly reference the paths of the model and weights
      ...
      // Load the model using bundleResourceIO with string paths
      const model = await tf.loadLayersModel(
        bundleResourceIO(require(modelJsonPath), modelWeightsPaths.map(path => require(path)))
      );
