...
import { Image, StyleSheet, View, FlatList, Animated, Dimensions, TouchableOpacity, NativeSyntheticEvent, NativeScrollEvent, ScrollView } from 'react-native';
  ...
  return (
    <ParallaxScrollView
      ...
      <ThemedView style={styles.educationalContent}>
        <ThemedText type="subtitle" style={styles.educationTitle}>Educational Content</ThemedText>
        <ThemedText style={styles.educationText}>
